...
export default function DurgaShantiHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred ritual for peace, protection, and blessings from Goddess Durga.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred ritual for peace, protection, and blessings from Goddess Durga.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Durga Shanti Homam.jpeg"
                  alt="Durga Shanti Homam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Goddess Durga for peace, harmony, and protection from negative influences.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Durga Shanti Homam</strong> is a sacred Vedic ritual performed to invoke the peaceful aspect of Goddess Durga for tranquility, protection, and harmonious living.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Goddess Durga (Peaceful and protective form)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed for peace and harmony in family and personal life, protection from negative energies and disturbances, removal of conflicts and obstacles, spiritual growth, and overall well-being.
    </p>

    <p>
      <strong>Benefits:</strong> Mental peace and emotional stability, protection from negativity and evil forces, harmony in relationships, removal of obstacles, prosperity and success, and spiritual upliftment.
    </p>

    <p>
      <strong>Suitable for:</strong> Families seeking peace and harmony, individuals facing conflicts or disturbances, those desiring protection, people on spiritual journeys, and anyone seeking the blessings of Goddess Durga.
    </p>

    <p>
      <strong>Best time to perform:</strong> During Navratri, Fridays, Ashtami, or as recommended by your priest.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Durga Shanti Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
