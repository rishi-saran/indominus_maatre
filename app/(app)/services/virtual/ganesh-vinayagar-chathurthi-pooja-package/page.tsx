...
export default function GaneshVinayagarChathurthiPoojaPackagePage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Complete pooja package for Ganesh Chathurthi celebrations with traditional rituals.',
    ...
    <section className="w-full px-6 pt-4 pb-16">
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        Ganesh / Vinayagar Chathurthi Pooja Package
        </h1>
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Complete pooja package for Ganesh Chathurthi celebrations with traditional rituals.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Ganesh  Vinayagar Chathurthi Pooja Package.png"
                  alt="Ganesh / Vinayagar Chathurthi Pooja Package"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To celebrate Ganesh Chathurthi with traditional puja and seek Lord Ganesha\'s blessings for prosperity and removal of obstacles.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Ganesh / Vinayagar Chathurthi Pooja Package</strong> is a comprehensive ritual package to celebrate the auspicious festival of Ganesh Chathurthi with traditional prayers, rituals, and offerings to Lord Ganesha.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Lord Ganesha (Remover of obstacles, Lord of beginnings)
    </p>

    <p>
      <strong>Purpose:</strong> This pooja is performed to celebrate Ganesh Chathurthi festival, seek blessings for new beginnings and ventures, remove obstacles from life, attain prosperity and success, and bring happiness to the family.
    </p>

    <p>
      <strong>Benefits:</strong> Removal of obstacles in all endeavors, success in new ventures and projects, prosperity and abundance, wisdom and intelligence, protection and blessings for the family, and spiritual growth.
    </p>

    <p>
      <strong>Package includes:</strong> Complete puja setup and decoration, Ganesh idol installation, traditional puja rituals, modak offerings and prasad, aarti and bhajans, and guidance for visarjan (immersion).
    </p>

    <p>
      <strong>Suitable for:</strong> Families celebrating Ganesh Chathurthi, individuals starting new ventures, those seeking removal of obstacles, and devotees of Lord Ganesha.
    </p>
...
<div className="mb-6">
  ...
  <div className="space-y-6 text-sm leading-relaxed text-[#2f3a1f]">
    ...
    <div>
      ...
      <p className="mt-2 text-[#4f5d2f]">
        The Ganesh Chathurthi puja typically takes 2.5-3 hours depending on the
        package selected and the rituals performed.
      </p>
    </div>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <p className="mb-5 text-sm text-[#4f5d2f]">
          In Economy package 1 Vadhyar will be there, complete puja rituals will be
          performed for 2:30 to 3 hours.
        </p>

        <p className="mb-2 font-medium">Procedure involved:</p>
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          <li>Ganesh idol installation</li>
          <li>Punyaha Vachanam, Maha Sankalpam</li>
          <li>Kalasa Pooja</li>
          <li>Ganesh Puja with offerings</li>
        </ul>
      </div>
    </div>
    ...
    <div className="overflow-hidden rounded-2xl border-2 border-[#2f9e44] bg-white shadow-lg min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <p className="mb-5 text-sm text-[#4f5d2f]">
          In Standard package 2 Vadhyar will be there, complete puja rituals will be
          performed for 2:30 to 3 hours.
        </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <p className="mb-5 text-sm text-[#4f5d2f]">
          In Premium package 4 Vadhyar will be there, complete puja rituals will be
          performed for 2:30 to 3 hours.
        </p>
