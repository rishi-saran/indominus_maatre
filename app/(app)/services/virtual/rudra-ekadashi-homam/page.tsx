...
export default function RudraEkadashiHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred ritual for blessings of Lord Shiva on Ekadashi.',
      image: '/services/virtual/Rudra Ekadashi Homam.jpeg',
      formData: formData,
    ...
    <section className="w-full px-6 pt-4 pb-16">
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        Rudra Ekadashi Homam
        </h1>
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred ritual for blessings of Lord Shiva on Ekadashi.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Rudra Ekadashi Homam.jpeg"
                  alt="Rudra Ekadashi Homam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Lord Rudra (Shiva) on the auspicious day of Ekadashi for spiritual growth, purification, and divine blessings.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Rudra Ekadashi Homam</strong> is a sacred Vedic ritual dedicated to Lord Rudra (Shiva) performed on the auspicious day of Ekadashi, along with Lord Agni.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Lord Rudra (Shiva) and Lord Agni (God of Fire)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed on Ekadashi (11th lunar day) to seek Lord Shiva\'s blessings for spiritual growth, purification of sins, removal of obstacles, and divine grace.
    </p>

    <p>
      <strong>Benefits:</strong> Spiritual purification and growth, removal of past sins and negative karma, enhanced devotion and meditation, blessings of Lord Shiva, mental peace and clarity, protection from negative influences.
    </p>

    <p>
      <strong>Suitable for:</strong> Spiritual seekers and devotees, those seeking purification, individuals on spiritual path, people desiring Lord Shiva\'s grace, anyone seeking mental peace, those observing Ekadashi vrat.
    </p>

    <p>
      <strong>Best time to perform:</strong> Ekadashi (11th lunar day), particularly during important Ekadashis like Mokshada Ekadashi, Vaikuntha Ekadashi, or as recommended.
    </p>

    <p>
      <strong>Offerings:</strong> Bilva leaves, sacred ash (vibhuti), rudraksha, ghee, milk, flowers, fruits, and traditional Shiva offerings.
    </p>

    <p className="text-xs italic">
      Note: This homam is especially powerful when performed on Ekadashi with fasting and devotion for maximum spiritual benefits.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Rudra Ekadashi Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
