...
export default function DhanvantariHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred ritual dedicated to Lord Dhanvantari for health, healing, and immunity.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred ritual dedicated to Lord Dhanvantari for health, healing, and immunity.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Dhanvantari Homam.jpeg"
                  alt="Dhanvantari Homam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Lord Dhanvantari for physical and mental healing, immunity, and overall well-being.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Dhanvantari Homam</strong> is a powerful Vedic ritual dedicated to Lord Dhanvantari, the divine physician and deity of Ayurveda, along with Lord Agni.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Lord Dhanvantari (Divine physician) and Lord Agni (God of Fire)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed to support physical and mental healing, accelerate recovery from illnesses, strengthen immunity, and promote overall well-being.
    </p>

    <p>
      <strong>Benefits:</strong> Powerful healing energy for chronic illnesses, protection against diseases and health issues, mental clarity and emotional balance, strengthened immune system, faster recovery from ailments, and overall vitality.
    </p>

    <p>
      <strong>Suitable for:</strong> Individuals suffering from health issues, those recovering from illness or surgery, people with chronic health conditions, those seeking to strengthen immunity, and anyone desiring overall wellness.
    </p>

    <p>
      <strong>Best time to perform:</strong> Ekadashi (11th day), Pournami (Full Moon), Thursdays, Dhanteras, or as recommended by your physician and priest.
    </p>

    <p>
      <strong>Offerings:</strong> Sacred healing herbs, tulsi (holy basil), turmeric, ghee, Navadhanyas (nine grains), and medicinal plants.
    </p>

    <p className="text-xs italic">
      Note: This ritual provides spiritual support for health and should be performed alongside proper medical treatment. It is not a substitute for professional medical care.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Dhanvantari Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
