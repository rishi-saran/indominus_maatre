...
export default function MahalakshmiHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred ritual for wealth, prosperity, and abundance.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred ritual for wealth, prosperity, and abundance.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/MAHALAKSHMI HOMAM.jpeg"
                  alt="MAHALAKSHMI HOMAM"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Goddess Mahalakshmi for wealth, prosperity, abundance, and financial success.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>MAHALAKSHMI HOMAM</strong> is a powerful Vedic ritual dedicated to Goddess Mahalakshmi, the divine source of wealth and prosperity, along with Lord Agni.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Goddess Mahalakshmi and Lord Agni (God of Fire)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed to invoke the blessings of Goddess Mahalakshmi for wealth, prosperity, financial abundance, success in business, and overall material well-being.
    </p>

    <p>
      <strong>Benefits:</strong> Financial prosperity and wealth accumulation, success in business and career, removal of financial obstacles, abundance in all aspects of life, stability and growth in income, blessings for material comforts.
    </p>

    <p>
      <strong>Suitable for:</strong> Business owners seeking prosperity, individuals facing financial difficulties, those starting new ventures, families desiring wealth and abundance, anyone seeking financial stability.
    </p>

    <p>
      <strong>Best time to perform:</strong> Fridays, Pournami (Full Moon), Diwali/Deepavali, during Margashira month, or during auspicious wealth-related occasions.
    </p>

    <p>
      <strong>Offerings:</strong> Lotus flowers, turmeric, kumkum, ghee, sacred grains, gold ornaments (for display), coins, and traditional Lakshmi offerings.
    </p>

    <p className="text-xs italic">
      Note: This ritual attracts prosperity through divine blessings and should be accompanied by honest work, ethical business practices, and responsible financial management.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Mahalakshmi Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
