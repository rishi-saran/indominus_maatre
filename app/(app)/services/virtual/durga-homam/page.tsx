...
export default function DurgaHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      id: serviceId,
      title: 'DURGA HOMAM',
      description: 'Powerful Vedic ritual to invoke Goddess Durga for protection, strength, and removal of obstacles.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Powerful Vedic ritual to invoke Goddess Durga for protection, strength, and removal of obstacles.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/DURGA HOMAM.jpeg"
                  alt="DURGA HOMAM"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Goddess Durga for protection from negativity, removal of obstacles, spiritual growth, and prosperity.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>DURGA HOMAM</strong> is a sacred Vedic ritual dedicated to Goddess Durga, the embodiment of strength, courage, and divine protection. This powerful homam invokes the mighty goddess to shield devotees from negativity and bless them with prosperity.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Goddess Durga (Divine Mother representing strength, courage, and protection)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed for protection from evil forces and negativity, removal of obstacles in all aspects of life, spiritual growth and transformation, prosperity and success, and overall empowerment.
    </p>

    <p>
      <strong>Benefits:</strong> Protection from evil forces and negative energies, inner strength and courage to face challenges, success in endeavors and removal of obstacles, mental peace and emotional balance, spiritual empowerment and growth, and blessings for family well-being.
    </p>

    <p>
      <strong>When performed:</strong> During Navratri (most auspicious), on special occasions requiring divine protection, during challenging times in life, on Tuesdays and Fridays (days sacred to the goddess), or as recommended by your astrologer.
    </p>

    <p>
      <strong>Ritual includes:</strong> Preparation and purification, Sankalp (statement of intent), Ganesh Puja (removing obstacles), Kalash Sthapana (installation of sacred pot), Durga Puja with elaborate offerings, Havan (sacred fire ceremony), and powerful Durga mantras chanting.
    </p>

    <p>
      <strong>Suitable for:</strong> Individuals seeking protection and courage, those facing obstacles or challenges, people experiencing negative influences, families desiring prosperity and harmony, and anyone on a spiritual growth journey.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Durga Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
