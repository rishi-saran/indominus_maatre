...
export default function LakshmiKuberaHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'To invoke divine blessings for wealth, fortune, and prosperity in life.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          To invoke divine blessings for wealth, fortune, and prosperity in life.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Lakshmi Kubera Homam.jpeg"
                  alt="Lakshmi Kubera Homam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To enhance financial success and abundance by harnessing the benevolent energies of Goddess Lakshmi and Lord Kubera.
            </p>
          </div>
...
>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Purpose:</strong> To invoke divine blessings for wealth, fortune, and prosperity in life.
    </p>

    <p>
      <strong>Significance:</strong> Goddess Lakshmi is revered as the embodiment of wealth and abundance, while Lord Kubera is the guardian of riches.
    </p>

    <p>
      <strong>Timing:</strong> The ceremony is ideally performed on Fridays or another auspicious day selected according to the individual\'s birth star.
    </p>

    <p>
      <strong>Primary Deities:</strong> Worship involves both Goddess Lakshmi and Lord Kubera, ensuring a comprehensive invocation of financial well-being and abundance.
    </p>

    <p>
      <strong>Essential Offerings:</strong> Lotus flowers and honey are the main offerings used during the ritual to symbolize and attract prosperity.
    </p>

    <p className="italic">
      "This sacred ritual is designed to enhance financial success and abundance by harnessing the benevolent energies of these powerful deities through venerated Vedic traditions."
    </p>
...
<div className="mb-6">
  ...
  <div className="space-y-6 text-sm leading-relaxed text-[#2f3a1f]">
    ...
    <div>
      ...
      <p className="mt-2 text-[#4f5d2f]">
        Homams are typically performed for 2.5 to 3 hours at the same time it also
