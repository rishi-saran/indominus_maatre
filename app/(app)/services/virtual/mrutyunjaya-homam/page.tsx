...
export default function MrutyunjayaHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred ritual for protection from death, diseases, and dangers.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred ritual for protection from death, diseases, and dangers.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Mrutyunjaya Homam.jpeg"
                  alt="Mrutyunjaya Homam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Lord Shiva for protection from death, diseases, dangers, and to grant longevity and good health.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Mrutyunjaya Homam</strong> is a powerful Vedic ritual dedicated to Lord Shiva in his life-giving aspect, along with Lord Agni.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Lord Shiva and Lord Agni (God of Fire)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed for protection from death, diseases, and dangers. It is one of the most powerful rituals for health, longevity, and overcoming life-threatening situations.
    </p>

    <p>
      <strong>Benefits:</strong> Protection from untimely death and accidents, recovery from serious illnesses and diseases, enhanced longevity and vitality, removal of fear and anxiety about death, protection from dangers and calamities, overall health and well-being.
    </p>

    <p>
      <strong>Suitable for:</strong> Individuals facing serious health issues, people recovering from critical illnesses, those seeking protection from dangers, anyone desiring longevity, families concerned about health, individuals in high-risk professions.
    </p>

    <p>
      <strong>Best time to perform:</strong> Mondays, Pradosham (13th day), Shivaratri, during health crises, or as recommended during challenging times.
    </p>

    <p>
      <strong>Offerings:</strong> Bilva leaves, sacred ash (vibhuti), rudraksha, ghee, milk, curd, honey, sugar, and sacred herbs.
    </p>

    <p className="text-xs italic">
      Note: This ritual provides divine protection and spiritual support. It should be performed alongside proper medical treatment and is not a substitute for professional healthcare.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Mrutyunjaya Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
