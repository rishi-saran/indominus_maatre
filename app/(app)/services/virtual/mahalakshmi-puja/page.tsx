...
export default function MahalakshmiPujaPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred worship for wealth and prosperity through Goddess Lakshmi.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred worship for wealth and prosperity through Goddess Lakshmi.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/MAHALAKSHMI PUJA.jpeg"
                  alt="MAHALAKSHMI PUJA"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To worship Goddess Mahalakshmi for wealth, prosperity, financial stability, and overall abundance.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>MAHALAKSHMI PUJA</strong> is a sacred Vedic worship dedicated to Goddess Mahalakshmi, the divine embodiment of wealth, prosperity, and abundance.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Goddess Mahalakshmi
    </p>

    <p>
      <strong>Purpose:</strong> This puja is performed to seek the blessings of Goddess Lakshmi for wealth, prosperity, financial stability, success in business, and overall material and spiritual abundance.
    </p>

    <p>
      <strong>Benefits:</strong> Financial prosperity and wealth growth, success in business and career endeavors, removal of debts and financial obstacles, abundance and comfort in life, stability in income and resources, blessings for family prosperity.
    </p>

    <p>
      <strong>Suitable for:</strong> Business owners and entrepreneurs, individuals seeking financial stability, families desiring prosperity, those starting new ventures, anyone facing financial challenges, households seeking abundance.
    </p>

    <p>
      <strong>Best time to perform:</strong> Fridays, Pournami (Full Moon), Diwali/Deepavali, Varalakshmi Vratam, during Margashira month, or auspicious financial occasions.
    </p>

    <p>
      <strong>Offerings:</strong> Lotus flowers, red roses, turmeric, kumkum, sandalwood paste, betel leaves, areca nuts, coconut, fruits, sacred grains, and special Lakshmi prayers.
    </p>

    <p className="text-xs italic">
      Note: This puja brings divine blessings for prosperity and should be complemented with honest work, ethical practices, and gratitude for what you have.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Mahalakshmi Puja (3000 japams)</li>
        </ul>
      </div>
    </div>
