...
export default function MahaSudarshanaHomamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Sacred ritual for protection from enemies and negative forces.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Sacred ritual for protection from enemies and negative forces.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Maha Sudarshana Homam.jpeg"
                  alt="Maha Sudarshana Homam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Objective:</strong> To invoke Lord Vishnu\'s Sudarshana Chakra for protection from enemies, negative forces, and removal of obstacles.
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <p>
      <strong>Maha Sudarshana Homam</strong> is a powerful Vedic ritual dedicated to Lord Vishnu\'s Sudarshana Chakra, along with Lord Agni.
    </p>

    <p>
      <strong>Deity Worshipped:</strong> Lord Vishnu (Sudarshana Chakra) and Lord Agni (God of Fire)
    </p>

    <p>
      <strong>Purpose:</strong> This homam is performed for protection from enemies, negative forces, evil spirits, and to remove obstacles. It invokes the divine power of the Sudarshana Chakra for victory and protection.
    </p>

    <p>
      <strong>Benefits:</strong> Protection from enemies and negative energies, removal of obstacles and hurdles, victory over adversaries, shield against evil forces and black magic, mental peace and confidence, success in legal matters.
    </p>

    <p>
      <strong>Suitable for:</strong> Individuals facing enemy troubles or competition, people experiencing negative energies, those in legal disputes, anyone seeking protection and victory, business owners facing challenges.
    </p>

    <p>
      <strong>Best time to perform:</strong> Thursdays, Ekadashi (11th day), Pournami (Full Moon), or during challenging situations requiring divine protection.
    </p>

    <p>
      <strong>Offerings:</strong> Sacred herbs, ghee, turmeric, kumkum, lotus flowers, tulsi leaves, and traditional Vishnu offerings.
    </p>

    <p className="text-xs italic">
      Note: This ritual provides spiritual protection and should be combined with ethical actions and positive intentions for best results.
    </p>
    ...
    <div className="overflow-hidden rounded-2xl border border-[#d8e2a8] bg-white shadow-sm min-h-[460px]">
      ...
      <div className="p-6">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-[#4f5d2f]">
          ...
          <li>Kalasa Pooja</li>
          <li>Maha Sudarshana Homam (3000 japams and tat dasams homam)</li>
        </ul>
      </div>
    </div>
