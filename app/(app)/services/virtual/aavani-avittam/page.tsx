...
export default function AavaniAvittamPage() {
  ...
  const handleBookService = () => {
    ...
    const serviceData = {
      ...
      description: 'Hindu ritual observed by Brahmin communities for sacred thread change and new beginning in Vedic studies.',
      ...
      <div className="mx-auto mt-4 mb-8 max-w-6xl text-center">
       <h1 className="text-3xl font-serif tracking-wide leading-tight text-[#2f3a1f]">
        ...
        <p className="mt-2 text-sm text-[#4f5d2f]">
          Hindu ritual for sacred thread change and new beginning in Vedic studies.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="w-[300px] rounded-2xl border border-[#cfd8a3] bg-white p-4 shadow-sm">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#eef4cf]">
                <Image
                  src="/services/virtual/Aavani Avittam.png"
                  alt="Aavani Avittam"
                  width={400}
                  height={400}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm text-[#4f5d2f]">
              <strong>Duration:</strong> 2:30-3 hrs
            </p>
            <p className="text-sm text-[#4f5d2f]">
              <strong>Deity:</strong> Lord Hayagreeva (Divine teacher)
            </p>
          </div>
  ...
  <div className="space-y-5 text-sm text-[#4f5d2f] leading-relaxed">
    ...
    <ul className="list-disc pl-5 space-y-2">
      <li>Renew sacred thread: Symbolizing spiritual renewal and rejuvenation</li>
      <li>Mark beginning of Vedic studies: Restarting Vedic recitation and studies</li>
      <li>Seek spiritual growth: Pursuing knowledge, wisdom, and self-purification</li>
      <li>Honor tradition: Observing an ancient ritual and cultural heritage</li>
      <li>Seek divine blessings: For spiritual growth, knowledge, and well-being</li>
    </ul>

    <p><strong>Significance:</strong></p>
    <ul className="list-disc pl-5 space-y-2">
      <li>Devotees renew their sacred thread (Janeu or Poonal), symbolizing spiritual renewal</li>
      <li>Marks the beginning of Vedic studies and recitation</li>
      <li>Believed to bring spiritual growth, knowledge, and self-purification</li>
    </ul>

    <p><strong>Benefits:</strong></p>
    <ul className="list-disc pl-5 space-y-2">
      <li>Spiritual growth and renewal</li>
      <li>Knowledge and wisdom enhancement</li>
      <li>Purification of mind, body, and soul</li>
      <li>Positive energies and vibrations</li>
    </ul>

    <p><strong>When performed:</strong> During the month of Aavani (August-September), typically in morning hours. The ceremony marks the commencement of Vedic studies, particularly the Yajur Veda.</p>
  </div>
)}
        ...
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            ...
            className={`cursor-pointer transition ${
              star <= rating ? "fill-[#f4c430] text-[#f4c430]" : "text-[#9ca67a]"
            }`}
          />
        ))}
      </div>
...
{tab === "faq" && (
  <div className="space-y-6 text-sm leading-relaxed text-[#2f3a1f]">
    <div>
      <p className="font-semibold">1. What is the significance of changing the sacred thread?</p>
      <p className="mt-2 text-[#4f5d2f]">The sacred thread change symbolizes spiritual renewal and marks a fresh beginning in one's Vedic studies and spiritual journey.</p>
    </div>
    <div>
      <p className="font-semibold">2. When is Aavani Avittam typically performed?</p>
      <p className="mt-2 text-[#4f5d2f]">Aavani Avittam is performed during the month of Aavani (August-September), with exact dates varying based on the lunar calendar and regional traditions.</p>
    </div>
    <div>
      <p className="font-semibold">3. Who can perform Aavani Avittam?</p>
      <p className="mt-2 text-[#4f5d2f]">Primarily observed by Brahmin communities, particularly those following Tamil and Kerala traditions who wear the sacred thread.</p>
    </div>
  </div>
)}
</div>
