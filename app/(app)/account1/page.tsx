...
export default function MyAccount() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#d6f0a8] via-[#eaf5b5] to-[#ffe6a3]">
      <div className="text-text-dark font-display antialiased min-h-screen flex flex-col relative overflow-x-hidden selection:bg-accent/30">
      {/* Notification Popups */}
        ...
        {popupNotifications.map((notification: Notification) => {
          ...
          return (
            <div
              ...
              className={`animate-pop-strong popup-green px-6 py-4 rounded-2xl font-semibold text-base text-green-700 flex items-center gap-3 pointer-events-auto shadow-2xl border-2 border-green-300 hover:shadow-green-200/50 cursor-pointer`}
            >
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center">
          ...
          <div className="relative z-70 w-full max-w-2xl p-6 rounded-2xl bg-white shadow-2xl animate-pop-strong max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-primary-dark mb-2">Booking Information</h3>
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">
                    <p className="text-[9px] text-text-light font-bold uppercase">Booking ID</p>
                    <p className="text-sm font-semibold text-text-dark">#BK-8902</p>
                  </div>
                  <div className="p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">
                  ...
                  <div className="p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">
                    ...
                    <p className="text-sm font-semibold text-text-dark">Jan 15, 2026</p>
                  </div>
                  <div className="p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">
                    <p className="text-[9px] text-text-light font-bold uppercase">Time</p>
                    <p className="text-sm font-semibold text-text-dark">09:00 AM IST</p>
                  </div>
                </div>
              </div>
              <div>
                <h3 className="text-base font-semibold text-primary-dark mb-2">Pandit Information</h3>
                <div className="p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">
                  <p className="text-sm font-semibold text-text-dark">Pandit Ravi Shastri & Team</p>
                  <p className="text-xs text-text-light mt-1">Experience: 15+ years</p>
                </div>
              </div>
              <div>
                <h3 className="text-base font-semibold text-primary-dark mb-2">About This Pooja</h3>
                <p className="text-sm text-text-dark leading-relaxed p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">Griha Pravesh is a sacred Hindu ritual performed to purify and bless a new home. This ceremony invokes divine blessings for prosperity, peace, and well-being in the household.</p>
              </div>
              <div>
                <h3 className="text-base font-semibold text-primary-dark mb-2">What's Included</h3>
                <div className="p-3 bg-primary/5 rounded-lg hover:bg-amber-200 transition-all cursor-pointer">
      ...
      {isBookingsModalOpen && (
        <div className="fixed inset-0 z-60 flex items-center justify-center">
          ...
          <div className="relative z-70 w-full max-w-3xl p-6 rounded-2xl bg-white shadow-2xl animate-pop-strong max-h-[80vh] overflow-y-auto">
            <h2 className="text-lg font-semibold mb-4">All Upcoming Bookings</h2>
            <div className="space-y-3">
              {/* Booking 1 */}
              <div className="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-xl border border-white/60 hover:bg-amber-200 transition-all cursor-pointer group shadow-sm">
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-text-dark">Griha Pravesh</p>
                    <p className="text-[9px] text-text-light">Ravi Shastri</p>
                  </div>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">Jan 15, 2026</span>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">09:00 AM</span>
                </div>
                <div className="text-right">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[9px] font-bold bg-green-100 text-green-700">CONFIRMED</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-xl border border-white/60 hover:bg-amber-200 transition-all cursor-pointer group shadow-sm">
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-text-dark">Vivah Sanskar</p>
                    <p className="text-[9px] text-text-light">Mohan Singh</p>
                  </div>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">Feb 28, 2026</span>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">10:30 AM</span>
                </div>
                <div className="text-right">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[9px] font-bold bg-blue-100 text-blue-700">PENDING</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-xl border border-white/60 hover:bg-amber-200 transition-all cursor-pointer group shadow-sm">
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-text-dark">Satyanarayan Pooja</p>
                    <p className="text-[9px] text-text-light">Rajesh Sharma</p>
                  </div>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">Mar 10, 2026</span>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">06:00 PM</span>
                </div>
                <div className="text-right">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[9px] font-bold bg-yellow-100 text-yellow-700">PROCESSING</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-xl border border-white/60 hover:bg-amber-200 transition-all cursor-pointer group shadow-sm">
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-text-dark">Durga Pooja</p>
                    <p className="text-[9px] text-text-light">Vikram Gupta</p>
                  </div>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">Mar 25, 2026</span>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-xs text-text-dark font-medium">05:00 PM</span>
                </div>
                <div className="text-right">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[9px] font-bold bg-green-100 text-green-700">CONFIRMED</span>
                </div>
      ...
      {/* Navigation */}
      <nav className="fixed top-4 inset-x-0 z-50 px-4 md:px-6 flex justify-center">
        <div className="bg-white/95 backdrop-blur-md w-full max-w-6xl rounded-full pl-6 pr-2 py-2 flex items-center justify-between shadow-xl shadow-lime-900/5 border border-white/60">
          <div className="flex items-center shrink-0">
            <a className="block relative group cursor-pointer" href="#">
              <h1 className="font-serif text-[28px] font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#dca500] to-[#65a30d] group-hover:scale-110 transition-transform">
                maathre
              </h1>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-2">
            <NavLink icon="home" label="Home" active={false} />
            <NavLink icon="calendar_month" label="Bookings" />
            <NavLink icon="wb_twilight" label="Panchang" />
            <NavLink icon="person" label="Profile" active={true} />
          </div>

          <div className="flex items-center gap-3 shrink-0">
            <button className="w-9 h-9 rounded-full text-text-dark hover:bg-primary-soft flex items-center justify-center transition-colors cursor-pointer group">
              <span className="material-symbols-outlined text-[20px] group-hover:scale-125">search</span>
            </button>
            <button onClick={() => setActiveSection('newbooking')} className="bg-primary hover:bg-primary-dark text-white px-5 py-2 rounded-full font-bold text-xs shadow-lg shadow-primary/20 transition-all flex items-center gap-2 cursor-pointer group hover:shadow-yellow-400/50">
      ...
      <main className="flex-1 w-full max-w-[1400px] mx-auto px-4 md:px-6 pt-24 pb-8 flex flex-col gap-4 relative z-10">
        {/* Header */}
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-3 mb-1">
          <div>
            <div className="inline-flex items-center gap-2 text-primary text-xs font-medium mb-1 pl-1 cursor-pointer hover:text-primary-dark group">
              <span className="material-symbols-outlined text-[14px] arrow-left group-hover:scale-110">arrow_back</span>
              <span className="group-hover:underline">Back to Home</span>
            </div>
            <h1 className="text-2xl md:text-3xl font-serif font-semibold text-text-dark/90">My Account</h1>
            <p className="text-text-light mt-1 max-w-xl font-light text-xs">
              Manage your personal information, view upcoming spiritual journeys, and track your orders.
            </p>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
          ...
          <aside className="lg:col-span-3 flex flex-col gap-4 sticky top-24">
            ...
            <SidebarMenu onItemClick={handleButtonClick} isActive={activeSection === 'sidebar'} onActive={() => setActiveSection('sidebar')} onNavigate={setActiveSection} />
          </aside>
          ...
          <div className="lg:col-span-9 flex flex-col gap-4">
            ...
            <div id="section-profileprefs">
              <ProfileAndPreferences
                ...
                handleEditOpen={openEditModal}
                profile={profile}
                isActive={activeSection === 'profileprefs'}
                onActive={() => setActiveSection('profileprefs')}
      ...
      <footer className="bg-white border-t border-primary/10 relative overflow-hidden mt-8">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <a className="text-text-dark hover:text-primary transition-colors text-xs font-semibold" href="#">
              Privacy Policy
            </a>
            <a className="text-text-dark hover:text-primary transition-colors text-xs font-semibold" href="#">
              Terms of Service
...
const UserProfileCard: React.FC<UserProfileCardProps> = ({ handleButtonClick, profile, onEdit, isActive, onActive }) => (
  <div
    className={`glass-card p-4 rounded-2xl text-center border-t-4 border-t-primary cursor-pointer transition-all hover:bg-amber-200 ${
  ...
  >
    ...
    <div className="flex items-center justify-center gap-2">
      <h3 className="font-serif font-semibold text-base text-primary-dark m-0">{profile.email}</h3>
    </div>
    <p className="text-text-light text-[11px] mb-2">Devotee since 2022</p>
    <div className="inline-flex items-center gap-1 bg-primary-soft text-primary-dark text-[9px] font-bold px-2 py-0.5 rounded-full">
...
const SidebarMenu: React.FC<SidebarMenuProps> = ({ onItemClick, isActive, onActive, onNavigate }) => {
  ...
  return (
    <div className={`glass-card rounded-2xl overflow-hidden p-1.5 flex flex-col gap-0.5 transition-all hover:bg-amber-200 ${
      isActive ? 'bg-yellow-100' : ''
    }`} onClick={() => onActive?.()}>
...
const StatsCards: React.FC<StatsCardsProps> = ({ isActive, onActive }) => (
  <div className={`grid grid-cols-1 md:grid-cols-3 gap-2 transition-all ${
    isActive ? 'bg-yellow-50 p-4 rounded-2xl' : ''
  }`} onClick={() => onActive?.()}>
    <StatCard
      icon="temple_hindu"
      ...
      value="12"
      badge="This Year"
      hoverIconBg="group-hover:bg-primary group-hover:text-white"
    />
    <StatCard
      icon="shopping_bag"
      iconBg="bg-primary-soft"
    ...
    <StatCard
      ...
      value="₹5k+"
      badge="Donations"
      hoverIconBg="group-hover:bg-primary-dark group-hover:text-white"
    />
  </div>
);
...
const StatCard: React.FC<StatCardProps> = ({ icon, iconBg, iconColor, title, value, badge, hoverIconBg }) => (
  <div className="bg-white p-3 rounded-2xl shadow-sm border border-white transition-all group cursor-pointer hover:bg-amber-200">
    ...
    <h4 className="text-xl font-serif font-semibold text-primary-dark">{value}</h4>
  </div>
);
...
const UpcomingRitual: React.FC<UpcomingRitualProps> = ({ handleButtonClick, isActive, onActive, onViewDetails, onViewAllBookings }) => (
  <section className={`transition-all ${
    ...
    <div className="flex items-center justify-between mb-2">
      <h3 className="text-lg font-serif font-semibold text-primary-dark">Upcoming Ritual</h3>
      <button onClick={() => onViewAllBookings?.()} className="text-xs font-bold text-primary hover:text-primary-dark transition-colors cursor-pointer bg-none border-none p-0">
        View All Bookings
      </button>
    </div>
    <div className="glass-card rounded-2xl p-1 overflow-hidden group hover:bg-amber-200 transition-all cursor-pointer">
      <div className="bg-white/50 rounded-xl flex flex-col md:flex-row gap-3 p-3 md:p-4 relative overflow-hidden">
        ...
        <div className="w-full md:w-1/3 h-32 md:h-auto rounded-xl overflow-hidden relative shadow-lg">
          ...
          <div className="absolute top-2 left-2 bg-white/90 backdrop-blur text-primary-dark text-[9px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1">
        ...
        <div className="flex-1 flex flex-col justify-between gap-2 relative z-10">
          <div>
            <div className="flex items-start justify-between">
              <h4 className="text-lg font-serif font-bold text-primary-dark mb-0.5">Griha Pravesh Pooja</h4>
              <div className="bg-primary/10 text-primary-dark p-1.5 rounded-md">
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              <div className="flex items-center gap-2 bg-white/60 p-2 rounded-lg border border-white">
                ...
                <div>
                  <p className="text-[9px] text-text-light font-bold uppercase">Date</p>
                  <p className="text-[11px] font-semibold text-text-dark">Jan 15, 2026</p>
                </div>
              </div>
              <div className="flex items-center gap-2 bg-white/60 p-2 rounded-lg border border-white">
                ...
                <div>
                  <p className="text-[9px] text-text-light font-bold uppercase">Time</p>
                  <p className="text-[11px] font-semibold text-text-dark">09:00 AM IST</p>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            <button onClick={() => { onActive?.(); onViewDetails?.(); }} className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-lg font-bold text-xs shadow-md transition-all flex-1 md:flex-none text-center cursor-pointer group hover:shadow-yellow-400/50">
              <span className="group-hover:scale-110 inline-block transition-transform">→</span> View Details
            </button>
            <button onClick={() => handleButtonClick?.('💬 Chat Opened')} className="bg-white hover:bg-amber-200 text-text-dark border border-primary/20 px-4 py-2 rounded-lg font-medium text-xs transition-all flex items-center gap-2 justify-center flex-1 md:flex-none cursor-pointer group hover:shadow-md">
...
const ProfileDetails: React.FC<ProfileDetailsProps> = ({ profile, onEdit, handleButtonClick, isActive }) => {
  return (
    <section
      ...
      className="bg-white/60 backdrop-blur-md rounded-2xl p-4 border border-white shadow-sm cursor-pointer transition-all"
    >
      <div className="flex items-start justify-between gap-3 mb-3">
        <h3 className="text-base font-serif font-semibold text-primary-dark flex-1">Profile Details</h3>
        <button onClick={(e) => { e.stopPropagation(); onEdit?.(); }} className="text-primary hover:text-primary-dark p-2 hover:bg-primary-soft rounded-full transition-colors cursor-pointer group flex-shrink-0" aria-label="Edit profile details">
...
const ProfileDetailItem: React.FC<ProfileDetailItemProps> = ({ icon, label, value }) => (
      <div className="flex items-center gap-3 p-3 bg-white rounded-2xl border border-white/60 hover:bg-amber-200 transition-colors cursor-pointer group">
    <div className="w-7 h-7 rounded-full bg-cream-dark border border-white/60 flex items-center justify-center text-primary-dark group-hover:bg-primary group-hover:text-white transition-colors">
    ...
    <div>
      ...
      <p className="text-xs text-text-dark font-medium">{value}</p>
    </div>
  </div>
);
...
const Preferences: React.FC<PreferencesProps> = ({
  ...
  <section className="bg-white/60 backdrop-blur-md rounded-2xl p-3 border border-white shadow-sm flex flex-col">
    <h3 className="text-base font-serif font-semibold text-primary-dark mb-3">Preferences</h3>
...
const PreferenceToggle: React.FC<PreferenceToggleProps> = ({ icon, label, enabled, onChange, isActive, onActive }) => (
  <div className={`flex items-center justify-between p-2 bg-white rounded-xl border border-white cursor-pointer group transition-all hover:bg-amber-200 ${
    isActive ? 'bg-yellow-100' : ''
  }`} onClick={() => onActive?.()}>
    ...
    <button
      ...
      className={`relative inline-flex h-4 w-8 items-center rounded-full transition-colors cursor-pointer ${enabled ? 'bg-primary' : 'bg-gray-200'}`}
    >
      <span
...
const PreferenceItem: React.FC<PreferenceItemProps> = ({ icon, label, value }) => (
  <div className="flex items-center justify-between p-2 bg-white rounded-xl border border-white cursor-pointer group">
    <div className="flex items-center gap-2">
      <span className="material-symbols-outlined text-primary text-[18px] group-hover:scale-125 transition-transform">{icon}</span>
      <span className="text-xs font-medium text-text-dark">{label}</span>
    </div>
    <span className="text-[9px] font-bold text-text-light bg-cream-dark px-2 py-0.5 rounded-full border border-primary/10">{value}</span>
  </div>
);
...
const RecentOrders: React.FC<RecentOrdersProps> = ({ isActive, onActive, onViewFullOrders }) => (
  <section className={`transition-all ${
    ...
    <div className="flex items-center justify-between mb-2">
      <h3 className="text-lg font-serif font-semibold text-primary-dark">Recent Orders</h3>
    </div>
    <div className="glass-card rounded-2xl overflow-hidden">
      ...
      <div className="p-2 bg-primary/5 text-center hover:bg-amber-200 rounded transition-all cursor-pointer">
        <a onClick={(e) => { e.preventDefault(); onViewFullOrders?.(); }} className="text-xs font-bold text-primary hover:text-primary-dark transition-colors inline-flex items-center gap-1 cursor-pointer group" href="#">
          View Full Order History
          <span className="material-symbols-outlined text-[14px] arrow-right group-hover:translate-x-1">arrow_forward</span>
        </a>
      </div>
    </div>
  </section>
...
const OrderRow: React.FC<OrderRowProps> = ({
  ...
  const statusColors = {
    green: 'bg-green-100 text-green-700 border-green-200 bg-green-600',
    blue: 'bg-blue-100 text-blue-700 border-blue-200 bg-blue-600',
    yellow: 'bg-yellow-100 text-yellow-700 border-yellow-200 bg-yellow-600',
  };

  return (
    <tr>
      <td colSpan={5} className="p-0 pb-2">
        <div className="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-xl border border-white/60 hover:bg-amber-200 transition-all cursor-pointer group shadow-sm">
          <div className="flex items-center gap-2 flex-1">
            <img alt="Item" className="w-6 h-6 rounded-lg object-cover" src={image} />
            <div>
              <p className="text-xs font-semibold text-text-dark">{productName}</p>
              <p className="text-[9px] text-text-light">{category}</p>
            </div>
          </div>
          <div className="flex-1 text-center">
            <span className="text-xs text-text-dark font-medium">{orderId}</span>
          </div>
          <div className="flex-1 text-center">
            <span className="text-xs text-text-dark font-medium">{date}</span>
          </div>
          <div className="flex-1 text-center">
          ...
          <div className="text-right">
            <span className="text-xs text-text-dark font-semibold">${amount}</span>
          </div>
        </div>
      </td>
    </tr>
