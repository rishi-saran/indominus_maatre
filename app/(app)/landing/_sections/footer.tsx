      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-1">
            <div className="grid lg:grid-cols-2 gap-1.5 items-center">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-sm font-[var(--font-playfair)] text-[var(--spiritual-green-dark)] mb-0.5">
              ...
              >
                <div className="flex-1 relative">
                  <div className="glass rounded-full p-1 border border-white/30">
                    <div className="flex items-center bg-white/80 rounded-full px-4 py-2.5">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-[var(--spiritual-green-dark)] text-white rounded-full font-semibold flex items-center gap-2 hover:bg-[#2E7D32] transition-all shadow-lg hover:shadow-xl"
                >
                  Subscribe
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-1.5">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-1.5">
            ...
            >
              <h3 className="text-xl font-[var(--font-playfair)] italic text-[var(--spiritual-green-dark)] mb-1">
                Maathre
              </h3>
              <p className="text-[var(--muted-foreground)] mb-1.5 text-xs">
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-9 h-9 glass rounded-full flex items-center justify-center text-[var(--muted-foreground)] hover:text-[var(--spiritual-green-dark)] hover:bg-[var(--spiritual-green-light)]/50 transition-colors border border-white/30"
                    >
            ...
            >
              <h4 className="font-semibold text-[var(--foreground)] mb-1.5 text-sm">
                Quick Links
              </h4>
              <ul className="space-y-1.5">
                {footerLinks.quickLinks.map((link, index) => (
                  <li key={index}>
                    <a
                      href={link.href}
                      className="text-xs text-[var(--muted-foreground)] hover:text-[var(--spiritual-green-dark)] transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
            ...
            >
              ...
              <div className="space-y-1.5 text-xs">
                <div className="flex items-start gap-2 text-[var(--muted-foreground)]">
                  <MapPin className="w-3 h-3 text-[var(--spiritual-green)] mt-0.5 flex-shrink-0" />
                  <span>#000, Building, Street<br />Area, City</span>
                </div>
                <div className="flex items-center gap-2 text-[var(--muted-foreground)]">
                  <Phone className="w-3 h-3 text-[var(--spiritual-green)]" />
                  <span>+91 9876543210</span>
                </div>
                <div className="flex items-center gap-2 text-[var(--muted-foreground)]">
                  <Mail className="w-3 h-3 text-[var(--spiritual-green)]" />
                  <a
